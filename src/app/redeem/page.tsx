...
export default function RedeemPage() {
  ...
  const getRarityBadgeColor = (rarity: string) => {
    switch (rarity) {
      case "COMMON": return "bg-zinc-100 text-zinc-650 border-zinc-200";
      case "RARE": return "bg-blue-50 text-blue-650 border-blue-200";
      case "EPIC": return "bg-purple-50 text-purple-650 border-purple-200";
      case "LEGENDARY": return "bg-amber-50 text-amber-650 border-amber-200";
      case "MYTHIC": return "bg-red-50 text-red-650 border-red-200";
      case "SECRET": return "bg-pink-50 text-pink-650 border-pink-200";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8 animate-fade-in">
          ...
          <div className="bg-card border border-border p-6 rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {shop.map((gift) => (
                <div key={gift.id} className="border border-border rounded-lg p-4 flex flex-col justify-between hover:border-zinc-350 transition-all bg-zinc-50/50">
        ...
        <div className="lg:col-span-1 animate-fade-in">
          <div className="bg-card border border-border p-6 rounded-lg shadow-sm sticky top-24">
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded p-3 mb-4 text-xs text-zinc-650 flex items-start gap-2">
            ...
            {userCards.length === 0 ? (
              ...
              <div className="space-y-4 max-h-[480px] overflow-y-auto pr-1">
                {userCards.map((uc) => {
                  ...
                  return (
                    <div key={uc._id} className="border border-border rounded-lg p-3 hover:border-zinc-350 transition-colors bg-zinc-50/20">
                      <div className="flex gap-3">
                        <img
                          src={card.imageUrl}
                          alt={card.title}
                          className="w-16 h-20 object-cover rounded border border-zinc-250 bg-zinc-50 flex-shrink-0"
                        />
