      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        {user && (
          <div className="flex items-center gap-2 sm:gap-4">
            <div className="flex items-center gap-2 text-[10px] sm:text-xs bg-zinc-50 border border-border px-2 py-1 rounded-md sm:px-3 sm:py-1.5 animate-fade-in">
            ...
            <div className="flex items-center gap-2">
              <span className="hidden sm:inline text-sm font-medium text-zinc-650 mr-1">
                {user.displayName}
              </span>
              <button 
